...
def create_trip(telegram_id, departure_country, destination_country, departure_currency, 
                destination_currency, exchange_rate, initial_amount, convert_currency_func):
    """
...
def update_exchange_rate(trip_id, new_rate, departure_balance):
    ...
    cursor.execute('UPDATE trips SET destination_balance = ? WHERE id = ?', (new_destination_balance, trip_id))
